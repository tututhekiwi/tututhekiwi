// Verifies that every <img>, <source srcset>, and <link rel="icon|apple-touch-icon"> path
// in your HTML files points to a file that exists in the repo.
...
const files = await globby(["*.html", "!node_modules/**", "!**/vendor/**"], {
  gitignore: true,
});
